...
@interface ZWCommonMenuView () <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic,strong) ZWCommonMenuView * selfMenu;
@property (nonatomic,strong) UITableView * contentTableView;;
@property (nonatomic,strong) NSMutableArray * menuDataArray;
@end

@implementation ZWCommonMenuView {
    UIView *_backView;
...
- (void)setUpUI{
//    self.backgroundColor = [UIColor colorWithRed:61/255.0 green:61/255.0 blue:61/255.0 alpha:1.0];
